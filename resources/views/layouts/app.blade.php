...
<body>
   ...
   <div class="p-4 sm:ml-64 pt-10 min-h-screen flex flex-col content-between">
      <div
         class="relative -z-10 text-white mt-12 h-44 w-full shadow-lg overflow-hidden rounded-xl bg-[url('http://rsiaandini.com/theme/Medicom/img/about-slider-img2.jpg')] bg-cover	bg-center">
         <div class="absolute flex flex-col items-center justify-center px-10 inset-0 h-full w-full bg-zinc-900/60">
            <h1 class="font-light text-sm mb-0">Keuangan</h1>
            <h1 class="font-semibold text-2xl text-white">Rekapan Embalase</h1>
         </div>   
      </div>
         <!-- CONTENT -->
         <main class="-mt-10 p-3 mx-3 bg-white rounded-xl">
            @yield('content')
         </main>
      <div class="text-gray-600 mt-4">
         <footer class="py-2">
            <div class="flex w-full flex-wrap items-center justify-center gap-6 px-2 md:justify-between">
               <p class="block w-full text-center antialiased font-sans text-sm leading-normal font-normal text-inherit">© 2025 RSIA Andini Pekanbaru
            </div>
         </footer>
      </div>
   </div>
